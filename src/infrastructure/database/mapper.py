...
from infrastructure.database.models.product import Product as ProductTable
from infrastructure.database.models.comment import ProductComment as ProductCommentTable
from infrastructure.database.models.category import Category as CategoryTable
